...
func TestNegaScout(t *testing.T) {
	testCases := []struct {
		...
		//},
		//{
		//	name: "make four (game-history 10)",
		//	playBoard: "..................." +
		//		"..................." +
		//		"..................." +
		//		"..................." +
	...
	for _, tc := range testCases {
		t.Run(tc.playBoard, func(t *testing.T) {
			...
			setChildren := getAllIndexChildren(tc.playBoard)
			value, index := algo.NegaScout(State{tc.playBoard, -1, 0, []int{}, machinePlayer, *tc.humanPlayer}, tc.depth, math.Inf(-1), math.Inf(1), 1, setChildren)
